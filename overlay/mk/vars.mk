...
OVERLAY_SCRIPTS_DIR_REL     = $(BINDIR)
...
OVERLAY_O_SCRIPTS_DIR       = $(OVERLAY_O:/=)$(OVERLAY_SCRIPTS_DIR_REL)
...
_OVERLAY_SED_EDIT_EXPR += $(call f_get_sed_edit,OVSCRIPTS,$(OVERLAY_SCRIPTS_DIR_REL))
...
METASH_OPTS += $(foreach x,INITDIR HOOKDIR FUNCTIONS ENVFILE METASCRIPTDIR OVSCRIPTS,-V $(x)=@@$(x)@@)
